...
exports.notifyCustomerSchema = exports.listCustomersSchema = exports.updateCustomerStatusSchema = exports.updateCustomerSchema = exports.createCustomerSchema = void 0;
...
exports.createCustomerSchema = {
    ...
    distribution_info: {
        ...
        custom: {
            options: (value) => {
                return Object.values(types_1.DistributionType).includes(value);
            },
    ...
    'payment_info.mode': {
        ...
        custom: {
            options: (value) => {
                return Object.values(types_1.PaymentMode).includes(value);
            },
 ...
 */
exports.updateCustomerStatusSchema = {
    id: {
        in: ['params'],
        isInt: {
            options: { min: 1 },
    ...
    status: {
        ...
        custom: {
            options: (value) => {
                return Object.values(types_1.QueueStatus).includes(value);
            },
