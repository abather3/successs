...
exports.DailyQueueResetService = void 0;
...
class DailyQueueResetService {
     ...
     */
    static async createDailySnapshot(client) {
     ...
     */
    static async archiveQueueData(client, snapshot) {
     ...
     */
    static async updateFinalDailyAnalytics(client, snapshot) {
        // Enable analytics update since tables exist
        try {
            await QueueAnalyticsService_1.QueueAnalyticsService.updateDailySummary(snapshot.date);
     ...
     */
    static async resetActiveQueue(client) {
     ...
     */
    static async resetDailyCounters(client) {
     ...
     */
    static async logResetActivity(client, snapshot) {
        await activity_1.ActivityService.log({
            user_id: -1, // System operation
     ...
     */
    static async broadcastResetNotification(snapshot) {
        try {
     ...
     */
    static async getDailyHistory(days = 30) {
        const query = `
      SELECT 
        date, 
     ...
     */
    static async getDisplayMonitorHistory(days = 30) {
        const query = `
      SELECT 
        date, daily_customers_served, daily_avg_wait_time,
        daily_peak_queue_length, daily_priority_customers,
...
exports.DailyQueueResetService = DailyQueueResetService;
//# sourceMappingURL=DailyQueueResetService.js.map